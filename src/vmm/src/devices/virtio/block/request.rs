...
// Everything here taken from Firecracker for now, with very small changes. We'll switch to the
// request building block from rust-vmm after we have the initial implementation.
